...
//get the settings whenever they change
//atom.config.get('asciidoc-reference-check.checkURL', true);
var cfgCheckURL
  ...
  reader.on('end', () => {
    ...
    function checkExternalURL(item) {
      ...
      return new Promise((resolve, reject) => {
          process.nextTick(() => {
            let opts = {
              aliveStatusCodes: [200, 401] //accept also Unauthorized (case of URL requiring a pwd)
            };
